...
export const AI_ACTIONS: Readonly<Record<AiActionId, AiActionDefinition>> = {
  ...
  SUBMISSION_DRAFT_INITIAL: {
    ...
    label: "Draft vendor message",
    description: "Drafts a concise first contact from vendor-visible records.",
    targetType: "SUBMISSION",
    outputSchema: SubmissionInitialDraftOutput,
    contextAudience: "VENDOR",
    producesPatch: true,
    allowedPatchFields: ["subject", "bodyMarkdown"],
    defaultEffort: "high",
    toolPolicy: "NONE",
  },
  SUBMISSION_DRAFT_FOLLOW_UP: {
    ...
    description: "Drafts a follow-up without inventing vendor commitments.",
    targetType: "SUBMISSION",
    outputSchema: SubmissionFollowUpDraftOutput,
    contextAudience: "VENDOR",
    producesPatch: true,
    allowedPatchFields: ["bodyMarkdown"],
    defaultEffort: "high",
    toolPolicy: "NONE",
  },
  SUBMISSION_CLASSIFY_REPLY: {
    id: "SUBMISSION_CLASSIFY_REPLY",
    label: "Classify reply",
    description: "Ranks reply labels for human confirmation.",
    targetType: "CORRESPONDENCE_MESSAGE",
    outputSchema: SubmissionReplyClassificationOutput,
    contextAudience: "VENDOR",
    producesPatch: true,
    allowedPatchFields: ["classification"],
    defaultEffort: "medium",
    toolPolicy: "NONE",
  },
  SUBMISSION_SUMMARIZE_THREAD: {
    id: "SUBMISSION_SUMMARIZE_THREAD",
    label: "Summarize thread",
    description: "Summarizes dated facts and unresolved questions.",
    targetType: "SUBMISSION",
    outputSchema: SubmissionThreadSummaryOutput,
    contextAudience: "VENDOR",
    producesPatch: false,
    allowedPatchFields: [],
    defaultEffort: "high",
  ...
  SUBMISSION_LEAK_REVIEW: {
    ...
    label: "Leak review",
    description: "Flags content that should not leave the workspace.",
    targetType: "SUBMISSION",
    outputSchema: LeakReviewOutput,
    contextAudience: "VENDOR",
    producesPatch: false,
