...
export const INTERNAL_TEMPLATE: ReportTemplate = {
  ...
  sections: [
    ...
    section(
      ...
      "Target / Asset",
      true,
      "The asset under test and how it was obtained or accessed.",
    ),
    section(
      "affected_versions",
      "Affected Versions",
    ...
    section(
      ...
      "Attack Path",
      false,
      "The steps from precondition to impact.",
    ),
    section(
      "impact",
      "Impact",
      true,
      "What an attacker gains, in security terms rather than adjectives.",
    ),
    section(
      "reproduction",
      "Reproduction",
      false,
      "Steps a colleague can follow to see the issue.",
    ),
    section(
      "poc",
      "Proof of Concept",
      false,
      "The proof-of-concept material and how to run it safely.",
    ),
    section(
      "evidence",
      "Evidence",
      false,
      "The captures, screenshots and artifacts that support the claims.",
    ),
    section(
      "scoring",
    ...
    section(
      ...
      "Disclosure Strategy",
      false,
      "The plan, and the reasoning behind the timing.",
    ),
    section(
      "disclosure_timeline",
      "Disclosure Timeline",
      false,
      "The recorded sequence of disclosure events.",
    ),
    ...
    section(
      ...
      "Appendices",
      false,
      "Supporting material that would interrupt the narrative.",
    ),
  ],
};
...
export const VENDOR_TEMPLATE: ReportTemplate = {
  ...
  sections: [
    ...
    section(
      ...
      "Affected Product",
      true,
      "The product, component and configuration affected.",
    ),
    section(
      "affected_versions",
      "Affected Versions",
      true,
      "Exact affected and unaffected versions.",
    ),
    section(
      "severity",
      "Severity and CVSS",
      true,
      "The approved vector and score, with the reasoning for each metric.",
    ),
    section(
      "description",
    ...
    section(
      ...
      "Security Impact",
      true,
      "What an attacker achieves against the vendor's users.",
    ),
    section(
      "preconditions",
      "Attack Preconditions",
      false,
      "Access, privileges or configuration required.",
    ),
    section(
      "technical_details",
      "Technical Details",
      true,
      "Enough detail for the vendor's engineers to locate the flaw.",
    ),
    section(
      "reproduction",
      "Reproduction Steps",
      true,
      "Steps the vendor can follow to reproduce it.",
    ),
    section(
      "poc",
      "Proof of Concept",
      false,
      "Proof-of-concept material cleared for the vendor.",
    ),
    section(
      "remediation",
    ...
    section(
      ...
      "Supporting Evidence",
      false,
      "Evidence cleared for vendor disclosure.",
    ),
    section(
      "timeline",
      "Disclosure Timeline",
      false,
      "The disclosure history to date.",
    ),
    section("references", "References", false, "External sources relied upon."),
    section(
      "contact",
      "Contact",
      true,
      "How to reach the researcher, and the expected response window.",
    ),
  ],
};
...
export const PUBLIC_TEMPLATE: ReportTemplate = {
  ...
  sections: [
    section(
      ...
      "Summary",
      true,
      "The advisory in a paragraph a reader can act on.",
    ),
    section(
      "affected_products",
      "Affected Products",
    ...
    section(
      ...
      true,
      "The vulnerability class, at a level appropriate for public release.",
    ),
    ...
    section(
      ...
      true,
      "What users should install or change.",
    ),
    section(
      "analysis",
      "Technical Analysis",
      false,
      "Deeper analysis, published only once a fix is available.",
    ),
    section(
      "timeline",
      "Disclosure Timeline",
    ...
    section(
      ...
      "Credits",
      false,
      "Who found it and who coordinated the fix.",
    ),
    section(
      "references",
      "References",
      false,
      "Vendor advisories and related publications.",
    ),
  ],
};
