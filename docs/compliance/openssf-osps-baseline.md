...
| OSPS-AC-03.01 | Gap | Default-branch protection is unavailable on the current private repository/free plan. |
| OSPS-AC-03.02 | Gap | Default-branch deletion protection has the same hosting-plan blocker. |
...
| OSPS-QA-01.01 | Gap | The authoritative repository is currently private. |
| OSPS-QA-01.02 | Gap | The change history is not publicly readable while the repository is private. |
...
Follow [`../security/repository-settings.md`](../security/repository-settings.md). Make the repository public or upgrade the GitHub plan, enable rulesets and security features, and verify user documentation. Then reassess every row and retain links to the settings evidence.
